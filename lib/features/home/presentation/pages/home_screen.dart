                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Expanded(
                              child: _buildButton("Medication Schedule",
                                  context, Icons.calendar_today,
                                  topLeft: true)),
                          const SizedBox(width: 10),
                          Expanded(
                              child: _buildButton("Book a Doctor", context,
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                              child: _buildButton(
                                  "Start Chat with Doctor", context, Icons.chat,
                                  bottomLeft: true)),
                          const SizedBox(width: 10),
                          Expanded(
                              child: _buildButton(
                                  "Disease History", context, Icons.history,
                                  bottomRight: true)),
                        ],
                      ),
                    ],
  ...
  Widget _buildButton(String text, BuildContext context, IconData icon,
    ...
    return InkWell(
      onTap: () {
        ...
        } else if (text == "Medication Schedule") {
